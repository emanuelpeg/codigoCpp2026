...
#include <memory>
#include "../CronometroEnClase/cronometro.h"
...
void Cronometro::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Cronometro *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject Cronometro::staticMetaObject = { {
    ...
    qt_meta_stringdata_Cronometro.offsetsAndSize,
    qt_meta_data_Cronometro,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Cronometro_t
, QtPrivate::TypeAndForceComplete<Cronometro, std::true_type>
...
void *Cronometro::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Cronometro.stringdata0))
